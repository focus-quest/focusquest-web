...
For the purposes of the EU General Data Protection Regulation (GDPR), we are the **data controller** for personal data processed through the App. If you have any questions, you can reach us at **support@focus-quest.app**.
...
To exercise any of these rights, email **support@focus-quest.app** from the email address associated with your FocusQuest account, or use the in-app **Settings → Delete Account** flow for deletion.
...
If you cannot access the in-app flow, email us at **support@focus-quest.app** and we will delete your account manually.
...
If you believe a child under the applicable age has provided us with personal information, please contact us at **support@focus-quest.app** and we will delete the account and associated data.
